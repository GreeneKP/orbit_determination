...
#   
        ...
        st.write(f"Looks like {sat_name} doesn't have enough data for the tool to work properly! Please orange:[select another satellite of interest] or green:[try again in the future] as more data becomes available!")
